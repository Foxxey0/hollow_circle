...
UINT16 resizingOriginalMousePosXRelativeToPos = 0; // its just the way the c window procedure parameters are. the mouse pos is relative to the window pos (top left).
UINT16 resizingOriginalMousePosYRelativeToPos = 0;
UINT16 resizingOriginalPosX = 0;
UINT16 resizingOriginalPosY = 0;
